    ...
    <div class="container">
        <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
            <div class="card card-register my-5 card-body">
                ...
                <form class="form-register" action="guru_crud.php" method="post">
                    ...
                    <br>
                    <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="regGuruButton"> Submit </button>
                </form>
            </div>
        </div>
    </div>
