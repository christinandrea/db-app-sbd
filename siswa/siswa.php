    ...
    <div class="container">
        <div class="col-sm-9  mx-auto">
            <div class="card card-register my-5 card-body">
                ...
                <form class="form-register" action="siswa_crud.php" method="post">
                    ...
                    <br>
                    <button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit" name="regSiswaButton"> Tambahkan Siswa</button>
                </form>
            </div>
        </div>
    </div>
